    ...
    value: function leftRowPositions(callback) {
      ...
      try {
        ...
        if (board[m][colIdx].filled == true) {
          ...
          while ((board[t][colIdx].filled == true || board[b][colIdx].filled == true || board[t][colIdx + 1].type !== 'X' || board[b][colIdx + 1].type !== 'X') && counter < 3 && span > 3) {
            //console.log('reducing')
            //top is occupied, reduce by a quarter of current span, usually just 1 because rooms are small right now
            if (board[t][colIdx].filled == true) {
              t = t + 1;
            ...
            if (board[t][colIdx].filled == false && board[b][colIdx].filled == false && originalT >= t && t < b && span > 3 && board[t][colIdx + 1].type !== 'X' && board[b][colIdx - 1].type !== 'X') {
              return [t, b];
            } //update the span
...
//# sourceMappingURL=index.js.516d4ea3ba1eb6fa6f3c.hot-update.js.map