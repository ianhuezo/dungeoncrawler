...
function () {
  ...
  function Room() {
    ...
    this.length = length;
    this.width = width; //the node that will decide the starting position

    this.parentCooridor = null; //a list of all the nodes that can put a cooridor
...
//# sourceMappingURL=index.js.062889fba9e5e28347d4.hot-update.js.map