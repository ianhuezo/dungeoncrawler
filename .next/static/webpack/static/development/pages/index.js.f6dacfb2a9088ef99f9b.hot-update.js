    ...
    value: function rightRowPositions(callback) {
      ...
      try {
        ...
        if (board[t][colIdx].filled == false && board[b][colIdx].filled == false) {
          ...
          while ((board[t][colIdx].filled == true || board[b][colIdx].filled == true || board[t][colIdx - 1].type !== 'H' || board[b][colIdx - 1].type !== 'H') && originalT < b && originalT >= t && counter < 3) {
...
//# sourceMappingURL=index.js.f6dacfb2a9088ef99f9b.hot-update.js.map