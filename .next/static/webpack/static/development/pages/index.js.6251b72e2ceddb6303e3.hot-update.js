...
function () {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Map, [{
      ...
      while (queue.length) {
        ...
        if (node) {
          ...
          for (var i = 0; i < this.removedHalls.length; i++) {
            ...
            this.board[row][col] = new _room__WEBPACK_IMPORTED_MODULE_2__["Node"]('-', this.removedHalls[i].position[0]);
          }
        }
      }
    ...
    value: function generateRooms(node) {
      ...
      this.removedHalls = removedHalls;
      return rooms;
    }
  }, {
    key: "generateHalls",
...
//# sourceMappingURL=index.js.6251b72e2ceddb6303e3.hot-update.js.map