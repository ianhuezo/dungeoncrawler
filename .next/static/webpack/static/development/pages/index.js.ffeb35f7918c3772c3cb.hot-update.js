...
function () {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Map, [{
    ...
    value: function generateRooms(node) {
      ...
      if (removedHalls) {
        for (var remove in removedHalls) {
          this.board[remove[0]][remove[1]] = new _room__WEBPACK_IMPORTED_MODULE_3__["Node"]('-', remove);
        }
      }
...
//# sourceMappingURL=index.js.ffeb35f7918c3772c3cb.hot-update.js.map