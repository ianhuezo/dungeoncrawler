          ...
          switch (halls[i].direction) {
            case 'r':
              ...
              if (newRoom) {
                ...
                this.roomCounter += 1;
                var removed = node.removeCooridor('r');
                console.log(removed);
              }
            ...
            case 'l':
              ...
              if (newRoom) {
                ...
                //remove the cooridor because it's not viable
                this.roomCounter += 1;
                var removed = node.removeCooridor('l');
                console.log(removed);
              }
            ...
            case 't':
              ...
              if (newRoom) {
                ...
                //remove the cooridor because it's not viable
                this.roomCounter += 1;
                var removed = node.removeCooridor('t');
                console.log(removed);
              }
            ...
            case 'b':
              ...
              if (newRoom) {
                ...
                //remove the cooridor because it's not viable
                this.roomCounter += 1;
                var removed = node.removeCooridor('b');
                console.log(removed);
              }
...
//# sourceMappingURL=index.js.699bc2bba55fb8622e0b.hot-update.js.map