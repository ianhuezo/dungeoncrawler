...
function () {
  ...
  function Node(roomWalls, position) {
    ...
    if (this.roomView == null) {
      ...
      this.type == 'H';
    } else if (roomView.corner) {
      //corner
      this.type = 'C';
    } //I don't allow corners to have rooms
    else if (roomView.left || roomView.right || roomView.bottom || roomView.top) {
        //
        this.type = 'X';
      } else {
        this.type = 'O';
...
//# sourceMappingURL=index.js.cca3288cf461c8fb592b.hot-update.js.map