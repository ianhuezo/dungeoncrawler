          ...
          switch (halls[i].direction) {
            case 'r':
              ...
              if (newRoom) {
                ...
                this.roomCounter += 1; //var removed = node.removeCooridor('l')
              }
            ...
            case 'l':
              ...
              if (newRoom) {
                ...
                //remove the cooridor because it's not viable
                this.roomCounter += 1; //var removed = node.removeCooridor('r')
              }
            ...
            case 't':
              ...
              if (newRoom) {
                ...
                //remove the cooridor because it's not viable
                this.roomCounter += 1; //var removed = node.removeCooridor('b')
              }
            ...
            case 'b':
              ...
              if (newRoom) {
                ...
                //remove the cooridor because it's not viable
                this.roomCounter += 1; //var removed = node.removeCooridor('t')
              }
...
//# sourceMappingURL=index.js.864216552ef46e11b0f3.hot-update.js.map