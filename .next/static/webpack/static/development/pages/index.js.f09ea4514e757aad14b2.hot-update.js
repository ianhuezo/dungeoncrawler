        ...
        switch (halls[i].direction) {
          case 'r':
            ...
            try {
              ...
              if (newRoom == null || this.board[rowStart][colStart + 1] == 'X' || this.board[rowStart][colStart + 1] == 'C') {
          ...
          case 't':
            ...
            try {
              ...
              if (newRoom == null || this.board[rowStart - 1][colStart] == 'X' || this.board[rowStart - 1][colStart] == 'C') {
                removedHalls.push(halls[i]);
                continue;
              }
...
//# sourceMappingURL=index.js.f09ea4514e757aad14b2.hot-update.js.map