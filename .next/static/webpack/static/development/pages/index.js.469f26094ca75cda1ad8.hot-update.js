      ...
      while (queue.length) {
        ...
        if (node) {
          ...
          for (var i = 0; i < this.removedHalls.length; i++) {
            ...
            this.board[row][col] = new _room__WEBPACK_IMPORTED_MODULE_2__["Node"]('-', this.removedHalls[i].position);
          }
        }
      }
...
//# sourceMappingURL=index.js.469f26094ca75cda1ad8.hot-update.js.map